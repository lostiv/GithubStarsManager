      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col gap-4 mb-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={() => { markAllForksAsRead(); backend.syncSettings({ readForks: forks.map(f => f.id) }).catch(() => {}); }}
          ...
          paginatedForks.map((fork) => {
            ...
            return (
              <ForkCard
                ...
                onMarkAsRead={() => { markForkAsRead(fork.id); backend.syncSettings({ readForks: [...readForks, fork.id] }).catch(() => {}); }}
